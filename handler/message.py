...
class CreateMessageHandler(urllib.request.BaseHandler):  # before is "baseHandler",now is"urllib.request.BaseHandler"
...
class MessagesHandler(urllib.request.BaseHandler):
    @tornado.web.authenticated
    def get(self, username = None, template_variables = {}):
        user_info = self.current_user
        template_variables["user_info"] = user_info
